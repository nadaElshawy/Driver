...
void UART1_Handler(void){
    g_pfnVirualVectors[UART1]();
}
void UART2_Handler(void){
    g_pfnVirualVectors[UART2]();
}
void UART3_Handler(void){
    g_pfnVirualVectors[UART3]();
}
void UART4_Handler(void){
    g_pfnVirualVectors[UART4]();
}
void UART5_Handler(void){
    g_pfnVirualVectors[UART5]();
}
void UART6_Handler(void){
    g_pfnVirualVectors[UART6]();
}
void UART7_Handler(void){
    g_pfnVirualVectors[UART7]();
}
